...
\begin{proof}
    ...
    从而\(\{x_k\}_{k \in \mathbb{Z}^+}\)不是基本序列，与{\kaishu 任一无限子集都有极限点}矛盾.
...
\begin{proof}
    ...
    考虑\(x \in \bigcup_{V_k \in \mathcal{C}} V_k\)，即\(\exists k \in \mathbb{Z}^+, x \in V_k, V_k \cap E\)至多可数，即\(x \in \mathbb{R}^n \setminus P\).
    ...
    因此\(B(p',r') \cap E\)是不可数集，\(p'\)也是\(E\)的凝点.\(\forall p \in P, r>0, \exists p' \in P' \subseteq P, d(p,p')<r\).
