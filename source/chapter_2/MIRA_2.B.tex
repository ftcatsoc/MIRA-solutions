\section{2.B Measurable Spaces and Functions}
...
\begin{proof}
    定义\(\mathcal{A}=\{B: \forall t \in \mathbb{R}, t+B \in \mathcal{B}(\mathbb{R})\}\)，下证\(\mathcal{A}\)是一个\(\sigma\)-代数.
...
\begin{comment}
    ...
    \begin{proof}
        ...
        则\(\exists n,j \in \mathbb{N}, \forall k \geq j, \abs*{f_k(x)-f_j(x)}<1/n<\varepsilon\)，于是\(f_1(x), f_2(x), \dots\)是基本序列.
